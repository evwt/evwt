(function (global, factory) {
  ...
  EvMenu.install = function (Vue, menu) {
    ...
    electron.ipcRenderer.on('evmenu:ipc:input', (event, message) => {
  ...
  function handleClick(menuItem, focusedWindow, event) {
    ...
    electron.app.emit('evmenu:app:input', {
      id: menuItem.id,
      event,
      item
    });

    electron.app.emit(`evmenu:app:input:${menuItem.id}`, item);
  ...
  __vue_render__$2._withStripped = true;
    ...
    const __vue_inject_styles__$2 = function (inject) {
      if (!inject) return
      inject("data-v-4c71db2d_0", { source: ".ev-toolbar[data-v-4c71db2d] {\n  user-select: none;\n}\n\n/*# sourceMappingURL=EvToolbar.vue.map */", map: {"version":3,"sources":["/Users/john/Code/evwt/packages/EvToolbar/src/EvToolbar.vue","EvToolbar.vue"],"names":[],"mappings":"AAYA;EACA,iBAAA;ACXA;;AAEA,wCAAwC","file":"EvToolbar.vue","sourcesContent":["<template>\n  <div class=\"ev-toolbar d-flex h-100 flex-middle p-xs\">\n    <slot />\n  </div>\n</template>\n\n<script>\nimport '@/../style/utilities.scss';\nexport default {}\n</script>\n\n<style lang=\"scss\" scoped>\n.ev-toolbar {\n  user-select: none;\n}\n</style>\n",".ev-toolbar {\n  user-select: none;\n}\n\n/*# sourceMappingURL=EvToolbar.vue.map */"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$2 = "data-v-4c71db2d";
    /* module identifier */
  ...
  exports.EvToolbar = __vue_component__$2;
  exports.EvToolbarItem = __vue_component__$3;
  exports.EvVirtualScroll = __vue_component__$4;
  exports.EvWorkbench = __vue_component__;
